...
class Stoner:
    def __init__(self):
        self.font_big = ImageFont.truetype("/var/www/html/plugins/NullDisplay/python/pitft/fonts/ViceCitySans.otf", 98)
        self.font_small = ImageFont.truetype("/var/www/html/plugins/NullDisplay/python/pitft/fonts/ViceCitySans.otf", 44)
        self.colorIndex = 0
    ...
    def Draw(self):
        ...
        if(self.StonerTime() == 710):
            return self.Draw710()
        return Image.open("/var/www/html/plugins/NullDisplay/python/pitft/bud.jpg")
        
    def Draw420(self):
        im = Image.open("/var/www/html/plugins/NullDisplay/python/pitft/bud.jpg")
        ...
        return im
    def Draw710(self):
        im = Image.open("/var/www/html/plugins/NullDisplay/python/pitft/wax.jpg")
        draw = ImageDraw.Draw(im)
        x = 50
        y = 10
        self.colorIndex += 1
