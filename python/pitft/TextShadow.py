...
class TextShadow:
    def __init__(self, big_size = 82, small_size = 24, med_size = 62):
        self.font_big = ImageFont.truetype("/var/www/html/plugins/NullDisplay/python/pitft/fonts/ViceCitySans.otf", big_size)
        self.font_med = ImageFont.truetype("/var/www/html/plugins/NullDisplay/python/pitft/fonts/ViceCitySans.otf", med_size)
